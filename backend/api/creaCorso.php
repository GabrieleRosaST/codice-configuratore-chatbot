...
function creaCorsoMoodle($fullname, $shortname, $categoryid, $summary = '', $format = 'topics', $argomenti) {
    ...
    //OVVIAMENTE ADESSO ANCORA IN LOCALE POI CAMBIEREMO  
    $ch = curl_init('http://localhost:3001/api/create-conversations');
    ...
    file_put_contents(__DIR__ . '/debug.log', "Invio a Node: HTTP $httpStatus, Risposta: $response\n", FILE_APPEND);
    ...
    return ['success' => true, 'course' => ['courseId' => $courseId, 'userId' => $userId]]; 
}